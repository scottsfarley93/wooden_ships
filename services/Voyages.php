...
$sql = "SELECT DISTINCT shipname, shiptype, name1, company, nationality, voyagefrom, voyageto  FROM logs WHERE ";

$colnames = array("ShipName", "ShipType", "Captain", "Company", "Nationality", "FromPlace", 'ToPlace');
